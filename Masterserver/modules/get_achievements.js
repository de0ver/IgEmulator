...
exports.module = function (stanza) {
	...
	if (profileObject.is_starting_achievements_issued != true) {
		...
		scriptProfile.updateAchievementsAmmount(profileObject, [{ id: 54, command: "set", amount: newRank }, { id: 55, command: "set", amount: newRank }, { id: 58, command: "set", amount: newRank }, { id: 93, command: "give" }, { id: 94, command: "give" }, { id: 95, command: "give" }], function (res) {
